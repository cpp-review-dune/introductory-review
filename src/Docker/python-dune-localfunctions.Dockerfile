...
LABEL maintainer="Oromion <caznaranl@uni.pe>" \
  name="python-dune-localfunctions Arch" \
  description="python-dune-localfunctions in Arch." \
  url="https://github.com/orgs/cpp-review-dune/packages/container/package/introductory-review%2Fpython-dune-localfunctions" \
